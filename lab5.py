...
while 1:
    user_number = int(input("Enter the number of words in your password between 3 and 7: "))
    if 3<= user_number <=7:
        password = passGen(user_number)
        print("Initial password:",password)
        new_password = rep_with_upper(password)
        swapped_password = swap_letters(new_password)
        print("Final version of the password:", swapped_password)
        result = search_letter(password, "k")
        result2 = search_letter(password, "K")
        if result | result2:
            print("True")
        else:
            print("False")
